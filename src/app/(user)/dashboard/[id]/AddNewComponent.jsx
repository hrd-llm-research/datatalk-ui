        ...
        >
          ...
          {charts.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-72 rounded-md">
              <Image src={"/assets/nocardchart.png"} alt="nochart" width={150} height={150} />
            ...
            <ScrollArea className="h-72 mt-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-center gap-8 mt-2">
